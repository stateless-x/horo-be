...
export const EARTHLY_BRANCHES = [
  ...
  {
    enumKey: "mao" as EarthlyBranch,
    pinyin: "mǎo",
    chinese: "卯",
    animal: "กระต่าย (Rabbit)",
    element: "wood" as Element,
  },
  {
    enumKey: "chen" as EarthlyBranch,
    pinyin: "chén",
    chinese: "辰",
    animal: "มังกร (Dragon)",
    element: "earth" as Element,
...
export const PILLAR_LIFE_AREAS = {
  year: {
    thai: "บรรพบุรุษ & สังคม",
    detail: "Ancestors, social image, early childhood (0-15)",
  },
  month: {
    thai: "พ่อแม่ & การทำงาน",
    detail: "Parents, career path, young adulthood (15-30)",
  },
  day: {
    thai: "ตัวเจ้า & คู่ครอง",
    detail: "Self identity, spouse, middle age (30-45)",
  },
  hour: {
    thai: "ลูกหลาน & อนาคต",
    detail: "Children, late career, later life (45+)",
  },
} as const;
 ...
 */
export const ELEMENT_ARCHETYPES: Record<
  Element,
  {
...
> = {
  wood: {
    corePersonality:
      "มีความเมตตากรุณา ชอบเติบโตและพัฒนาตัวเอง มีวิสัยทัศน์กว้างไกล",
  ...
  fire: {
    corePersonality:
      "มีพลังงานสูง กล้าหาญ มีเสน่ห์ดึงดูดใจ เป็นผู้นำโดยธรรมชาติ",
  ...
  earth: {
    corePersonality:
      "มั่นคง เชื่อถือได้ เป็นที่พึ่งพาของคนรอบข้าง มีความอดทนสูง",
  ...
  metal: {
    corePersonality:
      "มีความเด็ดขาด มีวินัยสูง มุ่งมั่นในเป้าหมาย ซื่อตรงและยุติธรรม",
    strengths: ["เด็ดขาด", "มีวินัย", "ซื่อตรง", "มุ่งมั่น"],
    weaknesses: [
      "เจ้าระเบียบเกินไป",
      "ขาดความยืดหยุ่น",
      "เข้มงวดกับตนเองและผู้อื่น",
    ],
