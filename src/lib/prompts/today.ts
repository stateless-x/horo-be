...
5. luckyNumbers: เลขมงคลประจำวันนี้ 3 เลข (array of numbers) ที่เกี่ยวข้องกับดวงชะตาของเจ้า${dailyContext ? ` — พิจารณาจากเสาวัน ${dailyContext.todayPillar.stemChinese}${dailyContext.todayPillar.branchChinese}` : ''}

6. luckyColor: สีมงคลประจำวันนี้ 1 สี (ภาษาไทย) ที่เจ้าควรใส่หรือพกติดตัว

7. luckyMoment: ช่วงเวลามงคลของวันนี้ (เช่น "ช่วงเช้า 06.00-09.00 น.")

8. warnings: 2-3 คำเตือนสำหรับวันนี้ สิ่งที่เจ้าต้องระวังเป็นพิเศษ อ้างอิงจากดวงชะตา${dailyContext?.branchClash.hasClash ? ` — ต้องรวมคำเตือนเรื่องการปะทะนักษัตร: ${dailyContext.branchClash.warning}` : ''}${mbtiType ? ` และจุดอ่อนของบุคลิกภาพเจ้า เช่น ถ้าเจ้ามักคิดมาก ให้เตือนเรื่องนี้เชื่อมกับดวงวันนี้` : ''}

9. suggestions: 3-4 คำแนะนำที่ปฏิบัติได้จริงสำหรับวันนี้ เจาะจงและเป็นรูปธรรม${mbtiType ? ` ปรับให้เหมาะกับบุคลิกภาพและจุดแข็งของเจ้า เช่น:
...
10. dos: 3 สิ่งที่ควรทำวันนี้ (เจาะจง อ้างอิงข้อมูลดวง)
11. donts: 3 สิ่งที่ควรหลีกเลี่ยงวันนี้ (เจาะจง)
